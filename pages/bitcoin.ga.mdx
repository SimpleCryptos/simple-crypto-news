...
![Beirt, duine amháin ag úsáid fón agus an duine eile ag úsáid ríomhaire glúine, ag seoladh nó ag fáil airgid dhigitigh.]({digital})
...
![Satharn, 3ú Eanáir 2009, ceannlíne Times Shasana: 'Chancellor on Brink of Second Bailout for Banks'. Sa fotheideal tá: 'Billions may be needed as lending squeeze tightens']({times})
...
![Seic stampáilte 'PAID'.]({checkPaid})

_**Tógann sé laethanta seic a phróiseáil**_

![Seic stampáilte 'INSUFFICIENT FUNDS'.]({checkInsufficient})
...
![Scéim cham taisce airgid idir-institiúideach ciorclach Banc Angla-Éireannach. Taispeánann sé trí íocaíocht; €978M ar an 26ú Méan Fómhar 2008, €2B ar an 29ú Méan Fómhar 2008 agus €4B ar an 30ú Méan Fómhar 2008.]({anglo1Ga})
...
![Grafach ag iarraidh go leor cóipeanna den mhórleabhar céanna a dháileadh ar fud na cruinne a thaispeáint.]({distributed})
...
![Grafach le dhá chiúb Rubik, ceann ar chlé nach bhfuil réitithe agus ceann ar dheis atá réitithe.]({rubik})
...
![Samplaí de CAPTCHAanna éagsúla.]({captcha})
...
![A hardware wallet and a phone app wallet.]({wallets})
...
![Tá seoladh Bonngiotán idir 26 agus 35 carachtar ar fhad, mar shampla: 1KvcJhqrFZ1DW5hpSQCYN3W4J2PLBRw94P. Líon iomlán na seoltaí féideartha Bonngiotán: 2¹⁶⁰ or 1461501637330902918203684832716283019655932542976.]({addressesGa})
...
![A face hidden by sunglasses.]({anonymous})
...
![Eochair siméadrach nochtaithe go contúirteach ar an ngréasán domhanda.]({symmetric})
...
![Eochracha príobháideacha neamhshiméadracha go sábháilte lena n-úinéirí, agus a n-eochracha neamhshiméadracha poiblí nochtaithe go neamhdhíobhálach agus go húsáideach ar an ngréasán domhanda.]({asymmetric})
...
![Seic sínithe ag Robert Redford.]({checkSigned})
...
![Gabháil scáileáin d’idirbheart seolta Bitcoin i gcomhéadan úsáideora gréasáin sparán crua-earraí Trezor. 0.12345678 Bonngiotán an méid atá á sheoladh, comhionann le €750.36 ag an am. Taispeántar táille ‘gnáth’ de 42 sat/B, ionann agus €0.43. Tugtar 'am dearbhaithe ionchais' de 50 nóiméad.]({transaction})
...
![Taispeántas simplithe den blocshlabhra Bonngiotán a thaispeánann go bhfuil an comhartha aitheantas uathúil an bhloc roimhe sa i ngach bloc.]({blockchainGa})
...
![Pictiúr portráid de Thomas Paine agus sliocht dá chuid: 'Dá mbeadh nó dá bhféadfadh luach a bheith ag rud ar bith atá cothrom le hór agus airgead, ní theastódh aon dlí tairisceana uaidh.']({thomasPaineGa})
...
![Mhéadaigh ráta boilscithe Bonngiotán go dtí os cionn 160% idir a thús i 2009 agus a bhuaic i 2011. Ó shin, tá sé ag laghdú go seasta go bhfuil sé ag 3.84% ag tús 2020 sa chairt seo.]({inflationGa})
...
![Tá méid teoranta de Bonngiotán, 21 milliún agus tá 18 milliún acu buailte cheana féin i 2020.]({supplyGa})
...
![Gabháil scáileáin den bosca liosta-anuas táillí den aip sparán Trezor. Tá 5 roghanna ann; 'High: 66 sat/B', 'Normal: 62 sat/B', 'Economy: 2 sat/B', 'Low: 1 sat/B', 'Custom'.]({fees})
...
![An taobh istigh d’fheirm mianadóireachta Bonngiotán i Sainte Hyacinthe, Québec.]({farm})
...
![Ionchuir1: 'Is doimhin é poll an amhrais.' Aschur1: 'e8219bc15d3226938e018f0ef061a5cc77b77a3bdc5b4e361f3f0a4876206fc4'. Ionchuir2: 'Is doimhin é poll. Gan amhrais.' Aschur2: '6e52a545b31920cdf142025f0084b41490c46fbfead894942fe009d88aec8d30'.]({sha256Ga})
...
![Leathanach íoslódála Linux Mint OS. Cuireann sé scátháin íoslódála ar fáil ó gach cearn den domhan chomh maith le meabhrúchán agus nasc chun an ISO íoslódáilte a fhíorú i gcás ina soláthraíonn siad luach hash sínithe go digiteach den ISO.]({checksumGa})
...
![Thosaigh Bonngiotáin le 8 náid mar an sprioc, mar shampla: 00000000839a8e6886ab5951d76f411475428afc90947ee320161bbf18eb6048. Teastaíonn 19 náid sa sprioc inniu, mar shampla: 0000000000000000000197a93a0af835ec72bad8d5b4808391b781e5cb95aef0.]({targetGa})
...
![focal ócáide, litríocht, ainmfhocal firinscneach den chéad díochlaonadh, béarla: nonce-word (noun).]({nonceGa})
...
![Lógónna f2pool agus slushpool a thaispeáint, gach ceann acu le slabhra a sheasann don bhlocshlabhra. Tá slabhra níos faide ag slushpool, dá bhrí sin tá an fíor-chóip den bhlocshlabhra acu.]({longest})
...
![Bloc Bonngiotán #416236, Stampa-Ama: 2016-06-14 07:50, Sonraí Bonnboinn: /HaoBTC/Sun Chun Yu: Zhuang Yuan, will you marry me?, https://blockchair.com/bitcoin/block/416236]({immutableGa})
...
![Tá minéir bradach ag obair ar dhá shlabhra ag aon am agus é mar aidhm aige idirbheart a fhoilsiú ar shlabhra amháin agus gan é a áireamh ar an dara slabhra.]({longestChain1Ga})

_**Minéir bradach ag obair ar dhá shlabhra ag aon am**_

![Caithfidh an minéir bradacha an slabhra a leathnú gan an t-idirbheart a theastaíonn uaidh a aisiompú sula leathnaíonn mianadóir eile an slabhra a bhfuil an bloc aige a theastaíonn uaidh a aisiompú.]({longestChain2Ga})
...
![Graf a thaispeánann an méadú ar mhéid an blocslabhra Bonngiotán ó 2009 go 2020 áit a sáraíonn sé 250GB. Tugann sé faoi deara gur shroich sé 50GB in 2015, 100GB in 2016, 200GB in 2018 agus 250GB in 2019.]({chainSizeGa})
...
![Leanann Bitcoin ag eisiúint leaganacha agus théann Litecoin ar a chonair eisiúint fhéin.]({forkingGa})
...
![Comhartha forc-ar-an-bhóthar a léiríonn scoilt, nó forc, Bonngiotán Airgead ó Bonngiotán (Cór).]({splitGa})

_**I mí Lúnasa 2017, chuir Bonngiotán Airgead bloic 8MB i bhfeidhm**_

![Bonngiotán Cór (BTC): Táille An Chéad Bloc Eile: $ 0.87; Táille Airmheán Reatha: $ 0.10. Bonngiotán Airgead (BCH): Táille An Chéad Bloc Eile: $0.0011; Táille Airmheán Reatha: $0.0006.]({bitcoinFeesGa})
...
![Criptea-airgeadra ceanglaí go paraisiúit á aerscaoileadh go talamh tar éis titim ó eitleán. Taispeántar trí cinn; NEM, Bitcoin Airgead agus Stellar Lumens.]({airdrop})
...
![Lógónna 3 mhalartán criptea-airgeadra, Coinbase, Binance agus Kraken.]({exchange})
...
![Grianghraf de Vitalik Buterin (ag caitheamh léine le lamas aon-adharcach, spásárthaí agus tuar ceatha).]({vitalik})
...
![Gabháil scáileáin de na 8 PuisíníCriptea is costasach le díol. Tá praghas ar 5 os cionn $1,000,000. Tá 2 os cionn $100,000 agus is é $75,000 praghas an 8ú ceann.]({kitties})
...
![Chuir Nike isteach ar phaitinn blocslabhra chun leaganacha digiteacha dá bhróga a chruthú 'chun cabhrú le húsáideoirí barántúlacht na bróga atá á gceannach acu a fhíorú, chomh maith le buntáistí eile'.]({nikeGa})
...
![Is blocslabhra sóisialta é Steem a fhásann pobail agus a chuireann sruthanna ioncaim láithreacha ar fáil d’úsáideoirí trí luach saothair a thabhairt dóibh as ábhar a roinnt.]({steemGa})
...
![Is malartú gealltóireachta gan teorainn é Augur nach féidir agus nach n-athróidh do theorainneachbunaithe ar d’fheidhmíocht.]({augurGa})
